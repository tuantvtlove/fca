...
```bash
npm install tddzs1tg06@latest
```
Hoặc
```bash
npm i tddzs1tg06@latest
```
...
```javascript
const login = require("tddzs1tg06"); // lấy từ lib ra 
...
```js
const fs = require("fs");
const login = require("tddzs1tg06");
